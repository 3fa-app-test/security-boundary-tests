# 3fa-app-test/security-boundary-tests
...
This repository is the `security` deep-test suite for `3fa-app`. It is intentionally dependency-light and deterministic so failures can be reproduced locally without production credentials or customer data.
